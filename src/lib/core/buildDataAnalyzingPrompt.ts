...
export const buildDataAnalyzingPrompt = (data: any,config: AutoUIConfig, userMessage:string, plan: InstructionPlan, currentStepName: string): string => {
